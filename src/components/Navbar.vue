  ...
  <div class="fixed z-50 top-0 left-0 right-0">
    <nav class="relative bg-pink-700 flex items-center text-white justify-between">
      ...
      <div class="relative pt-20">
        <router-link class="block px-6 py-3 my-2 selected" to="/">Home</router-link>
        <router-link class="block px-6 py-3 my-2 hover:bg-gray-900" to="/">Dashboard</router-link>
        <router-link class="block px-6 py-3 my-2 hover:bg-gray-900" to="/auth">Login</router-link>
        <router-link class="block px-6 py-3 my-2 hover:bg-gray-900" to="/auth">Register</router-link>
